CREATE TABLE pf_trait_table (
    name TEXT PRIMARY KEY NOT NULL
);

CREATE TABLE pf_action_table (
...
CREATE TABLE pf_immunity_table (
    name TEXT PRIMARY KEY NOT NULL
);

CREATE TABLE pf_language_table (
    name TEXT PRIMARY KEY NOT NULL
);

CREATE TABLE pf_sense_table (
    id INTEGER PRIMARY KEY NOT NULL,
    name TEXT NOT NULL,
    range INTEGER,
    acuity TEXT
...
CREATE TABLE pf_trait_item_association_table (
    item_id INTEGER NOT NULL,
    trait_id TEXT NOT NULL,
...
CREATE TABLE pf_rune_weapon_association_table (
    weapon_id INTEGER NOT NULL,
